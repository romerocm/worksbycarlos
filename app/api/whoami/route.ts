...
export async function GET(request: NextRequest) {
  ...
  const data = {
    ...
    fun_facts: [
      "I know how to play guitar, piano, bass, drums, harmonica and now learning saxophone!",
    ...
    curl_appreciation: isCurl
      ? "You're using curl! I like you already 😎"
      : "Try me with curl for extra geek cred! 🤓",
  };
  ...
  return NextResponse.json(data, {
    ...
    headers: {
      ...
      "X-Fun-Fact":
        "This endpoint was written while listening to lo-fi hip hop",
    },
  });
}
