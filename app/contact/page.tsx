...
export default function Contact() {
  ...
  const responses: Record<string, ChatMessage> = {
    ...
    "Do you own a design studio?": {
      ...
      type: "bot",
      content:
        "Yes! I own Vimi Studio (vimistudio.com), where we focus on creating beautiful and functional digital experiences. We combine design excellence with technical expertise to deliver outstanding results.",
    },
    "What's your tech stack?": {
      id: "tech",
      type: "bot",
      content:
        "I work with a wide range of technologies including AWS, GCP, Azure, Kubernetes, Terraform, Docker, and various CI/CD tools. For specific projects, I choose the best tools that fit the requirements.",
    },
    "Cloud Infrastructure": {
      id: "cloud",
      type: "bot",
